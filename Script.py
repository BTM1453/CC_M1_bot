class script(object):
    START_TXT = """ Hᴇʟʟᴏ {}, 𝖨'𝗆 𝖠 𝖬𝗈𝗏𝗂𝖾 𝖲𝖾𝖺𝗋𝖼𝗁 𝖡𝗈𝗍 𝖮𝖿𝖿𝗂𝖼𝗂𝖺𝗅𝗅𝗒 𝖬𝖺𝖽𝖾 𝖡𝗒 𝖳𝖾𝖺𝗆 😍
...
Added By - {}
"""
       RESULT_TXT="""<blockquote> Hey,</blockquote><blockquote>Jᴜsᴛ Sᴇᴇ Wʜᴀᴛ I Found Fᴏʀ Yᴏᴜʀ Qᴜᴇʀʏ </blockquote>"""

    CUSTOM_FILE_CAPTION = """📂Fɪʟᴇɴᴀᴍᴇ : {file_name}
FɪʟᴇSɪᴢᴇ : {file_size}

╔═══ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═══╗ 
➲ <a href="https://t.me/CINEMA_COMPANYE_Backup">CINEMA_COMPANY</a><br>
➲ <a href="https://t.me/+JObo3SXOiZRlNzll">Friday_Filim_House</a><br>
➲ <a href="https://t.me/+fgT9ogX7z144NjM1">Latest_Bot_Updates</a><br>
╚═══ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═══╝
